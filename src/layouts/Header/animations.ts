...
export const ICON_TRANSITION: Transition = { duration: 0.18, ease: EASE_AIR };
export const BACKDROP_TRANSITION: Transition = { duration: 0.35 };
export const MOBILE_NAV_TRANSITION: Transition = { duration: 0.35, ease: EASE_AIR };
export const BAR_TRANSITION: Transition = { duration: 0.35, ease: EASE_AIR };
export const NAV_ITEM_TRANSITION: Transition = { duration: 0.35, ease: EASE_AIR };
...
export const NAV_CTA_TRANSITION: Transition = { duration: 0.35, ease: EASE_AIR, delay: 0.35 };
