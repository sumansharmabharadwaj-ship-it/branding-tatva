  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 hidden h-11 w-11 items-center justify-center rounded-full border border-ivory/20 bg-soil/80 text-ivory shadow-elevation-sm backdrop-blur-md transition-all duration-300 hover:border-ivory/40 hover:bg-soil min-[2048px]:flex motion-reduce:flex"
      >
        {enabled ? (
