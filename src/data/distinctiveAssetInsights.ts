...
export const distinctiveAssetInsightPosts: InsightPost[] = [
  {
    slug: "distinctive-brand-assets-audit",
    title: "Distinctive brand assets: how to choose and audit them",
    seoTitle: "Distinctive brand assets: how to choose and audit them",
    excerpt:
      "A practical method for choosing, testing, and strengthening the visual and verbal cues that help people recognise a brand quickly.",
    directAnswer:
    ...
    primaryKeyword: "distinctive brand assets",
    secondaryKeywords: [
    ...
    framework: {
      title: "The five tests of a distinctive asset",
      introduction:
      ...
      steps: [
        ...
        },
        {
          title: "Difference",
          description:
            "The cue separates the brand from close competitors and category defaults.",
        },
        {
          title: "Attribution",
          description:
            "People can connect the cue with the correct brand without needing the full logo.",
        },
        {
          title: "Flexibility",
          description:
            "The cue survives websites, social posts, proposals, motion, and small screens.",
        },
        {
          title: "Repetition",
          description:
            "The business can use the cue consistently long enough for memory to form.",
        },
      ],
    },
    sections: [
      {
        id: "what-distinctive-brand-assets-are",
        heading: "What distinctive brand assets are",
        paragraphs: [
      ...
      {
        id: "distinctiveness-versus-differentiation",
        heading: "Distinctiveness and differentiation perform different jobs",
        paragraphs: [
      ...
      },
      {
        ...
        heading: "1. Inventory the cues already in use",
        paragraphs: [
      ...
      {
        id: "test-perception",
        heading: "2. Test whether the cue can be perceived",
        paragraphs: [
      ...
      {
        id: "test-attribution",
        heading: "4. Measure attribution rather than preference alone",
        paragraphs: [
      ...
      {
        id: "connect-assets-with-meaning",
        heading: "Connect recognition with the intended meaning",
        paragraphs: [
      ...
      {
        id: "govern-repetition-without-sameness",
        heading: "Repeat without making every execution identical",
        paragraphs: [
      ...
      {
        id: "audit-distinctive-assets",
        heading: "How to run a distinctive brand asset audit",
        paragraphs: [
      ...
      {
        id: "common-asset-errors",
        heading: "Common distinctive asset errors",
        paragraphs: [
    ...
    faq: [
      {
        question: "What are distinctive brand assets?",
        answer:
      ...
      {
        question: "Is a logo a distinctive brand asset?",
        answer:
      ...
      {
        question: "How many distinctive assets should a brand have?",
        answer:
      ...
      {
        question: "How do you measure whether a brand asset is distinctive?",
        answer:
      ...
      {
        question: "Should a rebrand replace existing distinctive assets?",
        answer:
