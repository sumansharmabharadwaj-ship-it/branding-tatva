...
export const aboutIntro = {
  ...
  body: [
    ...
    "That's what separates strategy from decoration. Most branding work optimizes for how a brand looks. This practice treats how a brand gets noticed, believed, and remembered as a discipline: attention and meaning, built with real intention.",
  ],
} as const;
