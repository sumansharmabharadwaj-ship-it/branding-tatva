...
export const insightPosts: InsightPost[] = [
  {
    ...
    searchIntent: "Build a positioning strategy around category, audience, alternatives, value, proof, and choice.",
  ...
  },
  {
    ...
    searchIntent: "Build a messaging framework that orders the promise, supporting claims, proof, and next action.",
    publishedAt: "2026-08-06",
    updatedAt: "2026-08-06",
    readingTime: "12 min read",
