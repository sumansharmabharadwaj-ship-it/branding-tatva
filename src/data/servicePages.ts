...
export const servicePages: ServicePageContent[] = [
  {
    ...
    questions: [
      ...
      { question: "Can you work remotely with a UK team?", answer: "Yes. Branding Tatva offers remote work with UK service businesses. Meeting times, decision makers, feedback rounds and handover materials are agreed before the project. Share any launch deadline during the first conversation so the proposal can address it." },
    ],
    reading: [
  ...
  },
  {
    ...
    title: "Brand Messaging Consultant for UK Service Businesses",
    description: "Brand messaging and tone of voice for UK service businesses. Work directly with Suman Sharma on your core message, proof, website language and writing guidelines.",
    updatedAt: "2026-09-22",
    headline: "Give your team one clear way to explain the business.",
    introduction: "Brand messaging connects what a business promises with the words buyers actually encounter. Working remotely with UK service businesses, Suman Sharma turns an agreed position into a core message, supporting reasons, evidence and practical voice guidelines.",
    ...
    boundary: "The first conversation establishes the writing problem and whether the position is ready to support the work. The proposal confirms deliverables, research, feedback rounds, timing and fees. Website development, a complete website rewrite and ongoing content production require their own agreed scope. Remote engagements are also available outside the UK.",
    engagement: {
