...
export const servicePages: ServicePageContent[] = [
  {
    ...
    title: "Brand Positioning Consultant | UK, US and Canada",
    description: "Brand positioning for service businesses in the UK, US and Canada. Work remotely with Suman Sharma to clarify your audience, competitive difference and messaging.",
    updatedAt: "2026-09-18",
    headline: "Give buyers a reason to choose you.",
    introduction: "Positioning defines the buyer, the alternatives they compare, and the reason your business deserves a place in that decision. At Branding Tatva, Suman Sharma leads this work directly, working remotely with service businesses in the UK, US and Canada.",
    ...
    engagement: {
      title: "Position around the buyers you want to reach in your market.",
  ...
  },
  {
    slug: "brand-audit",
    name: "Brand audit",
    title: "Brand Audit Services | UK, US and Canada",
    description: "A brand audit for service businesses in the UK, US and Canada. Review your positioning, messaging, identity and touchpoints with Suman Sharma before committing to a rebrand.",
    updatedAt: "2026-09-18",
    headline: "Find the problem before you fund the rebrand.",
    introduction: "A brand audit examines the gap between the business you run and the impression buyers receive. Working remotely with service businesses in the UK, US and Canada, Suman Sharma reviews positioning, language, identity and customer touchpoints to decide what needs attention first.",
