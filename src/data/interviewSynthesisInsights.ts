...
export const interviewSynthesisInsightPosts: InsightPost[] = [
  {
    ...
    keyTakeaways: [
      ...
      "Separate observation, interpretation, implication, and decision so attractive language never outruns the evidence.",
    ...
    sections: [
      {
        ...
        heading: "Customer quotes are evidence, never the positioning strategy",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Frequency matters, but it is only one signal. A pattern mentioned by fewer customers may still be strategically important if it describes the highest value buying situation or exposes a distinctive capability competitors rarely provide.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "A candidate can be strongly supported by customer language and still be a poor strategic choice if the business has no desire to build around that demand. Research informs strategy; it never hands leadership decisions to the sample.",
