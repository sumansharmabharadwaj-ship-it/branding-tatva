...
export const repositioningSectionsC: InsightSection[] = [
  {
    id: "test-before-launch",
    heading: "Test understanding and recognition before launch",
    paragraphs: [
  ...
  {
    id: "measure-after-launch",
    heading: "Measure the repositioning after launch",
    paragraphs: [
  ...
  {
    id: "ninety-day-plan",
    heading: "A recognition safe repositioning plan over ninety days",
    paragraphs: [
