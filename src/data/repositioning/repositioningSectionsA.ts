...
export const repositioningSectionsA: InsightSection[] = [
  ...
  {
    id: "why-established-brands-risk-more",
    heading: "Why an established business carries more repositioning risk",
    paragraphs: [
  ...
  {
    id: "diagnose-repositioning-need",
  ...
  {
    id: "build-recognition-baseline",
    heading: "Build a recognition and association baseline",
    paragraphs: [
