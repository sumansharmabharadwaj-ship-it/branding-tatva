import type { InsightSection } from "@/data/pillarInsights";

export const repositioningSectionsB: InsightSection[] = [
  {
    id: "inventory-distinctive-assets",
    heading: "Inventory the assets that already carry recognition",
    paragraphs: [
  ...
  {
    id: "build-transition-narrative",
    heading: "Build a transition narrative customers can follow",
    paragraphs: [
