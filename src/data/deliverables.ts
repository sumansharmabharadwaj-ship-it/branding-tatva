...
export const deliverables: Deliverable[] = [
  ...
  },
  {
    ...
    why: "A message can only carry value when you know exactly who it is for.",
  ...
  },
  {
    ...
    why: "A strong identity gets recognised even with the logo covered.",
  ...
  },
  {
    ...
    why: "A campaign earns attention when it carries what the brand stands for, rather than decorating it.",
  ...
  },
  {
    ...
    why: "Consistency creates memory. A voice that changes on every channel gets diluted instead of remembered.",
  ...
  },
  {
    ...
    why: "The first words the brand says decide which category people file it under.",
  ...
  },
  {
    ...
    why: "New brand rules meet real situations fast; support keeps every decision consistent with them.",
  ...
  },
  {
    ...
    group: "Continuity",
    what: "A quarterly session that reviews the position against what the market did.",
