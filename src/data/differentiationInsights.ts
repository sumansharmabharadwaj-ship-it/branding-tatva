...
export const differentiationInsightPosts: InsightPost[] = [
  {
    slug: "find-real-differentiator-crowded-service-market",
    title: "How to find a real differentiator in a crowded service market",
    seoTitle: "How to find a real differentiator in a crowded service market",
    excerpt:
      "A practical method for finding a difference that changes customer choice, rather than decorating the same offer with fresher words.",
    directAnswer:
    ...
    primaryKeyword: "how to differentiate a service business",
    secondaryKeywords: [
    ...
    heroImage: "/images/generated/insights-v3/differentiator-choice-to-consequence.webp",
    heroVideo: "/videos/generated/insights-v3/differentiator-choice-to-consequence.mp4",
    heroImageAlt:
    ...
    framework: {
      ...
      steps: [
        ...
        },
        {
          title: "Consequence",
          description:
            "Explain how that decision changes the customer experience, risk, speed, clarity, or result.",
        },
        {
          title: "Relevance",
          description:
            "Connect the consequence with a live customer situation that affects choice.",
        },
        {
          title: "Proof",
          description:
            "Show visible evidence that the business can sustain the claimed difference.",
        },
        {
          title: "Discipline",
          description:
            "Repeat the choice through offers, messaging, delivery, and content long enough to earn recognition.",
        },
      ],
    },
    sections: [
      {
        id: "what-a-real-differentiator-is",
        heading: "What a real differentiator is",
        paragraphs: [
      ...
      {
        id: "begin-with-buying-situation",
        heading: "Begin with the buying situation",
        paragraphs: [
      ...
      {
        id: "look-inside-the-method",
        heading: "Look inside the method before inventing the message",
        paragraphs: [
      ...
      {
        id: "use-tradeoffs",
        heading: "Use tradeoffs to sharpen the difference",
        paragraphs: [
        ...
        callout: {
          label: "Positioning clue",
          text:
            "The thing a business is willing to sacrifice often reveals the thing it is genuinely built to protect.",
        },
      },
      {
        id: "compare-behaviour-not-slogans",
        heading: "Compare competitor behaviour, rather than slogans alone",
        paragraphs: [
      ...
      {
        id: "test-the-differentiator",
        heading: "Test the differentiator before building the brand around it",
        paragraphs: [
      ...
      {
        id: "translate-difference-into-system",
        heading: "Translate the difference into the whole brand system",
        paragraphs: [
      ...
      {
        id: "common-false-differentiators",
        heading: "Common false differentiators",
        paragraphs: [
    ...
    faq: [
      {
        question: "What is a good differentiator for a service business?",
        answer:
      ...
      {
        question: "Is customer service a strong differentiator?",
        answer:
      ...
      {
        question: "Should a differentiator stay the same forever?",
        answer:
