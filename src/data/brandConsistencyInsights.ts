    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "A proposal should feel more detailed than an Instagram post. Onboarding should feel more operational than the homepage. Delivery documents should prioritise usefulness over theatrical presentation. Consistency never requires these touchpoints to look or sound identical.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Consistency is different from performing the same ritual for every client. The method can adapt while the underlying principles remain visible. A brand built around clarity should keep decisions understandable. A brand built around depth should make the reasoning inspectable.",
