...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "Why brand strategy needs five elements, not one",
    excerpt:
    ...
    body: [
      ...
      "Most projects that come in asking for \"content\" are really missing Earth. Most projects asking for \"positioning\" already have Earth but have never translated it into Air anyone outside the founder's head can actually repeat. The value of naming the five separately isn't philosophical, it's diagnostic: it tells you which part of the problem you're actually looking at before you spend money on the wrong one.",
  ...
  },
  {
    ...
    excerpt:
      "Being present isn't the same as being recognised. That gap is usually a clarity problem, far more often than a visibility one.",
    element: "fire",
    ...
    body: [
      ...
      "The gap between the two is usually a clarity problem, not a volume one. A message repeated inconsistently across five channels doesn't compound, it dilutes. A message repeated consistently, even at lower volume, is what actually earns a place in someone's memory rather than their scroll history.",
      "This is why \"post more\" is so often the wrong prescription. The right question isn't whether people are seeing the brand. It's whether what they're seeing is specific enough, and consistent enough, to survive the moment after they look away.",
    ],
  },
  {
    ...
    body: [
      ...
      "The audit's job is to find exactly where that story stops holding together, and to be specific about it: not \"the brand feels inconsistent\" as a vague note, but the actual sentence-level and decision-level places where it splits.",
      "That's also why an audit has to come before a rebuild. Redesigning a website on top of an unresolved positioning problem doesn't fix the problem, it just gives it a nicer coat of paint. Fixing the seam first means everything built afterward, the design, the content, the launch, is reinforcing the same story instead of adding one more version of it.",
    ],
  },
];
