export const faqs = [
  {
    ...
    answer:
      "More than a logo — purpose, positioning, audience, voice, identity, content, and consistency. I work across all five, using whichever elements a business actually needs.",
  },
  {
