...
export const serviceNamingInsightPosts: InsightPost[] = [
  {
    ...
    framework: {
      title: "The naming gravity test",
      introduction:
        "Five questions decide whether an offer should stay close to the parent brand or develop more identity of its own.",
      steps: [
        { title: "Clarity", description: "Can the customer understand what the offer is from the name and its immediate context?" },
        { title: "Relationship", description: "Does the name make its connection with the parent brand and neighbouring services obvious?" },
        { title: "Recall", description: "Does this offer need independent memory, or is remembering the parent brand enough?" },
        { title: "Search", description: "Will the name help discovery and category understanding rather than hide the service behind invented language?" },
        { title: "Governance", description: "Can the business support the explanation, assets, domains, content, and rules that greater independence creates?" },
      ],
    },
    sections: [
      {
        id: "name-is-navigation",
        heading: "Treat service names as navigation before treating them as creative assets",
        paragraphs: [
          "A customer encounters a service name inside a decision. They may be scanning a navigation menu, comparing proposal options, asking for a referral, searching online, or trying to remember which package solved their problem. The name should reduce effort in those moments.",
          "Invented names can create intrigue, but they also create explanation debt. A visitor who sees Foundation, Ascend, and Orbit still needs to discover whether those are workshops, retainers, strategy engagements, or software tiers.",
          "Begin with the job the name needs to perform. Clarity can be distinctive when the category is full of vague metaphors.",
        ],
      },
      {
        id: "choose-naming-mode",
        heading: "Choose the naming mode before brainstorming words",
        paragraphs: [
      ...
      {
        id: "build-naming-grammar",
        heading: "Build one naming grammar across the portfolio",
        paragraphs: [
      ...
      {
        id: "avoid-mini-brands",
        heading: "Avoid creating a miniature brand for every new offer",
        paragraphs: [
        ...
        callout: {
          label: "Naming rule",
          text: "A service deserves a useful name long before it deserves a separate brand.",
        },
      },
      {
        id: "search-and-language",
        heading: "Keep category language visible for search and comprehension",
        paragraphs: [
      ...
      {
        id: "name-by-portfolio-role",
        heading: "Name offers according to their role in the portfolio",
        paragraphs: [
      ...
      {
        id: "test-service-names",
        heading: "Test service names inside real buying contexts",
        paragraphs: [
      ...
      {
        id: "govern-names-over-time",
        heading: "Govern the naming system as offers evolve",
        paragraphs: [
