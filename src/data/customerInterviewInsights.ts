    ...
    sections: [
      ...
      },
      {
        ...
        callout: {
          label: "Language rule",
          text:
            "Never improve the customer's sentence while taking notes. Awkward language can contain the exact tension polished brand language erased.",
        },
      },
      {
      ...
      {
        id: "analyse-evidence",
        heading: "Analyse evidence by decision pattern, never quote popularity",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Qualitative research reveals mechanisms, meanings, language, and patterns. By itself it leaves open how common each pattern is in the wider market.",
      ...
      },
      {
        ...
        callout: {
          ...
          text:
            "The goal is never to make customers write the strategy. The goal is to understand the decision reality well enough to make a sharper strategic choice.",
        },
      },
    ],
    faq: [
