...
export const homepageMessagingInsightPosts: InsightPost[] = [
  {
    slug: "homepage-messaging-service-businesses",
    title: "Homepage messaging for service businesses: what the first screen must do",
    seoTitle: "Homepage messaging for service businesses",
    excerpt:
    ...
    secondaryKeywords: [
      ...
      "service business homepage copy",
    ...
    keyTakeaways: [
      ...
      "Proof should appear near the claims it supports instead of being quarantined in one testimonial block.",
      "Service descriptions should help a buyer choose a path rather than simply list capabilities.",
      "The final call to action should feel like the natural consequence of the argument the page has already made.",
    ],
    framework: {
      title: "The homepage decision sequence",
      introduction:
    ...
    sections: [
      ...
      {
        id: "first-screen",
        heading: "The first screen should orient before it tries to impress",
        paragraphs: [
        ...
        callout: {
          label: "Hero test",
          text: "After five seconds, can a relevant buyer say what kind of business this is and why the page may matter to them?",
        },
      },
      {
      ...
      },
      {
        ...
        heading: "Explain the distinctive choice before the feature list",
        paragraphs: [
          "Service businesses often move from problem language directly into capabilities. That leaves the buyer knowing what the firm does without understanding why this firm approaches the work differently.",
          "Use one section to explain the choice, philosophy, process order, specialisation, or tradeoff that shapes the service. Connect that choice to a customer consequence so differentiation feels operational rather than decorative.",
          "A distinctive method can then organise the service list. Individual capabilities feel easier to value when they appear as parts of a coherent approach.",
        ],
      },
      {
        id: "proof-near-claims",
        heading: "Place proof beside the claims it needs to support",
        paragraphs: [
          "A homepage should distribute credibility. If the page claims strategic depth, show process evidence, relevant credentials, or a thoughtful diagnostic method nearby. If it claims commercial impact, connect that claim with a verified case outcome. If it claims founder involvement, make that involvement visible.",
          "One large testimonial carousel cannot carry every type of proof. Different claims need different evidence. Work samples prove craft. Case studies prove reasoning and context. Testimonials prove experienced value. Process detail proves repeatability.",
          "Treat proof as part of the argument rather than a decorative trust strip.",
        ],
      },
      {
        id: "service-navigation",
        heading: "Turn the service section into a choice architecture",
        paragraphs: [
          "A service grid should help the visitor decide where they belong. Group services by customer situation, outcome, stage, or level of intervention when that makes the choice clearer.",
          "Avoid giving every service equal visual weight simply because every service matters internally. Lead with the offers most connected to the position and the customers the business wants more of.",
          "Each service description should answer the situation it is for, the change it creates, and why it differs from neighbouring options. The detail can continue on the service page.",
        ],
      },
      {
        id: "about-and-authority",
      ...
      {
        id: "final-cta",
        heading: "Make the final CTA the conclusion of the page, rather than a repeated button",
        paragraphs: [
      ...
      {
        id: "homepage-audit",
        heading: "Audit the homepage by asking what each section makes easier",
        paragraphs: [
          "Review the page section by section and assign one primary job to each part: orient, create recognition, explain difference, provide proof, help choose, deepen trust, or prompt action.",
          "Sections with no clear decision job are candidates for removal or redesign. Repetition can be useful when it reinforces one idea; repetition becomes clutter when several sections restate the same claim without adding evidence or progression.",
          "Finally, read only the headings in order. They should tell a coherent story even before the supporting copy is read.",
        ],
        bullets: [
          "Can the right visitor identify the category quickly?",
          "Does the page describe a specific customer situation?",
          "Is the distinctive choice explained before detailed capabilities?",
          "Does important proof sit near important claims?",
          "Can the visitor choose between services without decoding internal terminology?",
          "Does the final action explain what happens next?",
        ],
      },
    ],
    faq: [
      ...
      { question: "What is the best homepage CTA for a consulting or branding business?", answer: "Use a next step that matches the buying process, such as viewing work, exploring a service, requesting an audit, or booking a conversation. Explain what happens after the action to reduce uncertainty." },
      { question: "How often should homepage messaging be updated?", answer: "Review it when the positioning, audience, service architecture, proof, or buying process changes. Stable language can build recognition, so avoid rewriting the page simply because the internal team has become familiar with it." },
    ],
    relatedSlugs: [
