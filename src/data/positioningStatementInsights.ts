...
export const positioningStatementInsightPosts: SourcedInsightPost[] = [
  {
    ...
    heroImage: "/images/generated/insights-v3/positioning-statement-specificity-filter.webp",
    heroVideo: "/videos/generated/insights-v3/positioning-statement-specificity-filter.mp4",
    heroImageAlt:
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Words such as innovative, trusted, tailored, high quality, strategic, collaborative, and results driven are neutral on their own. They become generic when the business cannot show a distinctive mechanism, tradeoff, or consequence behind them.",
        ],
        bullets: [
      ...
      },
      {
        ...
        heading: "A template is never a positioning process",
        paragraphs: [
        ...
        callout: {
          label: "Sequence rule",
          text:
            "Never ask the template to discover the strategy. Use the strategy to decide what deserves a place in the template.",
        },
      },
      {
        ...
        paragraphs: [
          ...
          "The second version is better for reasons other than length. It identifies a buying situation, narrows the customer, names a process choice, creates a consequence, and makes proof easier to request.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "The following examples are deliberately written as internal working statements. None of them is a slogan to copy. Each one shows the type of specificity that makes a statement useful.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Specificity should appear in the logic rather than merely in the nouns. Naming an industry can narrow the audience while leaving the value generic. Naming a buying situation, operating constraint, or tradeoff often creates more useful precision.",
      ...
      },
      {
        ...
        paragraphs: [
          "Replace the brand name with the name of a close competitor. If the statement still feels accurate, underline every transferable phrase. Those phrases may still earn their place, but they cannot carry the position alone.",
          "Next, replace the category. A statement promising tailored solutions, trusted expertise, and exceptional results may work for an agency, accountant, architect, consultant, or software company. That flexibility shows the sentence has yet to reach the operating reality of the business.",
      ...
      },
      {
        ...
        paragraphs: [
          "Numbers, niche labels, and invented process names can make a statement appear specific without making it more useful. A narrow audience is weak when the service was built around something other than that audience's situation. A method with five steps is weak when those steps mirror the standard category process.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "When every channel requires a different explanation, the statement is either too abstract or the business has yet to accept the tradeoffs it contains.",
        ],
        bullets: [
          "Which service now leads the menu?",
          "Which enquiry is a strong fit, and which is a weak one?",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Draft several positions using different customer situations and comparison frames. Resist forcing consensus too early. The contrast between drafts reveals which choices create relevance and which merely preserve internal comfort.",
      ...
      },
      {
        ...
        paragraphs: [
          "Rewrite the statement when the audience, category, offer, evidence, buying situation, or competitive frame has materially changed. Never rewrite it merely because the team is bored with the language.",
          ...
          "A permanently frozen sentence is the wrong goal. The goal is a stable strategic centre that can absorb better evidence and clearer language without becoming a new business every quarter.",
        ],
      },
    ],
    faq: [
      ...
      },
      {
        ...
        answer:
          "Use a template to organise validated choices, never to invent them. Copying the structure is harmless; copying another brand's strategic logic usually produces a sentence that sounds specific while remaining disconnected from your service.",
      },
    ],
    relatedSlugs: [
