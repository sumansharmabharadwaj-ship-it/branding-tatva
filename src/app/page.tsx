...
export const metadata: Metadata = {
  title: { absolute: `${site.name} | Brand Strategy for UK, US and Canada` },
  description: site.description,
  alternates: { canonical: "/" },
  openGraph: {
    title: `${site.name} | Brand Strategy for UK, US and Canada`,
    description: site.description,
    url: site.url,
    type: "website",
  },
  ...
  "@graph": [
    {
      ...
      "@id": `${site.url}/#webpage`,
      url: site.url,
      name: `${site.name} | Brand Strategy for UK, US and Canada`,
      description: site.description,
