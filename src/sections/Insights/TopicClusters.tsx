                ...
                {isOpen && (
                  ...
                  >
                    ...
                    <dl className="space-y-4">
                      {pillar.terms.map((t) => (
                        <div key={t.term} className="rounded-2xl border border-ivory/12 p-4 transition-colors duration-300 hover:border-ivory/30" style={{ backgroundColor: "rgba(244,239,230,0.04)" }}>
