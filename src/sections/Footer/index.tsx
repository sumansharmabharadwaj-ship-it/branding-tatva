            ...
            <div className={`${WIDGET_CLASS} flex flex-col justify-center gap-5 sm:w-[240px] sm:shrink-0`}>
              <div>
                ...
                <p className="mt-3 text-sm text-ivory/80">
                  A solo practice for service businesses in the UK, US and Canada, working remotely. Suman leads the thinking, writing, and direction. Also serving founders in India.
                </p>
              </div>
            </div>
