  ...
  return (
    <div className="relative py-20 sm:py-28">
      ...
      <Container className="relative max-w-5xl">
        ...
        {/* Desktop retains one compact vertical journey. A small amount of
            native scrolling advances the active rung, grows the signal rail,
            changes the market consequence, and updates the proof companion.
            Clicking a rung pauses the automatic climb while the visitor reads. */}
        <div
                  ...
                  <div
                    ...
                    className={`group relative rounded-2xl border px-5 py-4 transition-[transform,border-color,background-color,box-shadow,opacity] duration-400 ${
                      isActive
                        ...
                        : "border-transparent opacity-62 hover:translate-x-1 hover:opacity-100"
                    }`}
                  >
                    <motion.span
