      ...
      >
                  ...
                  return (
                    <motion.li
                      ...
                      whileInView={
                        prefersReducedMotion
                          ? undefined
                          : { opacity: active ? 1 : 0.45, x: active ? 5 : 0, filter: "blur(0px)" }
                      }
        ...
        <div className="mt-8 hidden overflow-hidden rounded-2xl border border-ivory/14 bg-[rgba(16,20,22,0.56)] p-5 backdrop-blur-md lg:block sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-ivory/10 pb-4">
            ...
            <div
              className="grid grid-cols-2 gap-1 rounded-full border border-ivory/12 bg-black/10 p-1"
              role="group"
              aria-label="Compare generic and distinct positioning"
            >
              <button
                type="button"
                    ...
                    {WEAK.map((item, index) => (
                      <motion.li
                        ...
                        whileInView={
                          prefersReducedMotion
                            ? undefined
                            : { opacity: index === activeIndex ? 1 : 0.55, filter: "blur(0px)" }
                        }
