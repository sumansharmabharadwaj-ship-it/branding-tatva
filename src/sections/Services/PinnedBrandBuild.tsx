...
// The Authority build uses CSS position sticky plus measured scroll progress.
// The old 420vh range made five meaningful states consume more than four
// complete viewports. The same five-layer assembly now resolves inside 220svh,
// the upper bound of the Services scroll-compression brief: every small wheel
// gesture still changes the wave, the active layer, the connector state, and
// the teaching copy, but the visitor no longer pushes through a scroll cage.
