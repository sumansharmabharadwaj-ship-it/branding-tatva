  ...
  return (
    ...
    >
      <div className="rounded-[1.75rem] border border-ivory/14 bg-[rgba(12,19,15,0.78)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.34)] backdrop-blur-xl">
          ...
          {themes.map((theme, index) => {
            ...
            return (
              <div key={theme} data-health-theme={theme} className="min-w-0">
                ...
                />
                <span
                  className={`mt-1 block truncate text-[0.52rem] uppercase tracking-[0.09em] ${
                    complete || current ? "text-ivory/65" : "text-ivory/30"
                  }`}
                >
                  {theme}
                </span>
        ...
        <div
          data-health-question-stage="true"
          className="relative mt-5 min-h-[18rem] border-t border-ivory/10 pt-5"
          aria-live="polite"
        >
              ...
              >
                ...
                {hasSpread && strongest !== null && weakest !== null && (
                  <p className="mt-3 text-xs leading-relaxed text-ivory/65">
                    Strongest signal: {themes[answers.indexOf(strongest)].toLowerCase()}. Clearest gap:{" "}
                    {themes[answers.indexOf(weakest)].toLowerCase()}.
                  </p>
                )}
                {resultPackage && (
                ...
                <div className="mt-5 grid gap-2.5">
                  ...
                  <LinkButton
                    href="#desire"
                    variant="secondary"
                    className="w-full justify-center border-ivory/30 text-ivory hover:bg-ivory/10"
                  >
                    See that package
                  </LinkButton>
                  <button
