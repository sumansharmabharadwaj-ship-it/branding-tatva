...
const files = [
  ...
  "src/sections/Services/PinnedBrandBuild.tsx",
...
assert(films.length === 14, `Expected 14 distinct Services-route films, found ${films.length}`);
...
process.stdout.write(`Services media release gate passed: ${films.length} distinct films, all at least 16 seconds.\n`);
