...
| --- | --- | --- |
| Home | Forest hero, editorial type, proof card, chapter navigation and original retained chapters | Hero grade is lighter, header and proof card use warm ivory, consent is compact, and the guided journey is reduced from 13 to 8 chapters. Counter reads `01/08`. |
