...
- The Paths grade was opened by roughly one stop so the valley film reads immediately as footage instead of a dark solid field, while the copy side keeps its contrast veil.
